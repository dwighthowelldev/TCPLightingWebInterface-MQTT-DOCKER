...
define("LIGTHING_BRIDGE_IP",                            "IPTCPLIGHTS");                                 // IP address of TCP Bridge/Gateway
define("LIGHTING_BRIDGE_PORT",                          "PORTTCPLIGHTS");                                               // 443 for new firmware, 80 for legacy - If you don't know, leave it at 443
define("LOCAL_URL",                                             "http://localhost");                    // Address of your webserver running this - this is used in runSchedule to call the API

define("USER_EMAIL",                                            "USEREMAIL");                   // I think this is so you dont have to regenerate tokens if you run this script elsewhere
define("USER_PASSWORD",                                         "USERPASSWORD");                        // can be anything
define("USE_TOKEN_FILE",                                        1);                                     // store the token in a file vs hard coding it below otherwise fill in line 51

define("FORCE_FADE_ON",                                         FORCEFADEON);                                   //makes it so when lights are turned off they fade to 0 (Like Philips Bulbs)
define("FORCE_FADE_OFF",                                        FORCEFADEOFF);                                  //makes it so when lights are turned on they fade to their assigned value from 0 (Like Philips Bulbs)
...
$HASSTopic_id = "HomeAssistant-Topic_id";                // Topic prefix for Home Assistant Discovery Topics - this must match with HASS
